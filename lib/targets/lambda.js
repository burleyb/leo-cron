...
let lambdaWarmupOffset = process.env.lambda_warmup_offset != undefined ? parseInt(process.env.lambda_warmup_offset) : 4;
...
module.exports = function(target, payload, opts = {}) {
	...
	return new Promise((resolve, reject) => {
		...
		timeoutHandle = setTimeout(() => request.abort(), 2000);
		resolve({});
	});
};
